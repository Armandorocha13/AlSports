...
export const roupasTreinoProducts = [
  ...
  },
  {
    ...
    featured: true,
    priceRanges: [
      { min: 1, price: 80.00 }, // 1 CALÇA
      { min: 2, max: 4, price: 75.00 }, // 2-4 CALÇAS
      { min: 5, price: 70.00 } // 5+ CALÇAS
    ]
  },
  {
    id: '32',
    ...
    featured: true,
    priceRanges: [
      { min: 1, price: 120.00 }, // 1 CASACO
      { min: 2, max: 4, price: 110.00 }, // 2-4 CASACOS
      { min: 5, price: 100.00 } // 5+ CASACOS
    ]
  },
  {
    id: '33',
    ...
    description: 'Corta vento tailandês do Fluminense para treino com proteção contra vento.',
    sizes: ['P', 'M', 'G', 'GG'],
    category: 'roupas-treino',
    subcategory: 'corta-vento',
    featured: true,
    priceRanges: [
      { min: 1, price: 100.00 }, // 1 CORTA VENTO
      { min: 2, max: 4, price: 90.00 }, // 2-4 CORTA VENTOS
      { min: 5, price: 80.00 } // 5+ CORTA VENTOS
    ]
  }
];
