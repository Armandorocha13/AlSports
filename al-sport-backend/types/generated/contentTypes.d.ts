...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ImagemDaCategoria: Schema.Attribute.Media<
...
export interface ApiConteudosDoSiteConteudosDoSite
  extends Struct.CollectionTypeSchema {
  collectionName: 'conteudos_do_sites';
  info: {
    displayName: 'Contatos';
    pluralName: 'conteudos-do-sites';
    singularName: 'conteudos-do-site';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    EnderecoFisico: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::conteudos-do-site.conteudos-do-site'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TelefoneWhatsapp: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pedidos realizados no site';
    displayName: 'Pedido';
    pluralName: 'pedidos';
    singularName: 'pedido';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    NomeCliente: Schema.Attribute.String & Schema.Attribute.Required;
    NumeroPedido: Schema.Attribute.String & Schema.Attribute.Unique;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Aguardando Pagamento'>;
    Telefone: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ValorFrete: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    ValorProdutos: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    ValorTotal: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiProdutoProduto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Variacao: Schema.Attribute.Component<'variacoes.variacoes', true>;
  };
}
...
export interface ApiSubcategoriaSubcategoria
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ImagemDaSubcategoria: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::conteudos-do-site.conteudos-do-site': ApiConteudosDoSiteConteudosDoSite;
